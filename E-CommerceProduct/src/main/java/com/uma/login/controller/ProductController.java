...
//ProductTable
    ...
    public ResponseEntity<ProductTable> getProductById(@PathVariable Long productId) {
        Optional<ProductTable> product = productService.getProductById(productId);
    ...
    @PostMapping("/add/product")
   	public ResponseEntity<ProductTable> addProducts(@RequestBody ProductTable product) {
   		return new ResponseEntity<>(productService.savedProducts(product),HttpStatus.CREATED);
       }
...
//@Mapping PostMapping 
      ...
      public ResponseEntity<Product> createProduct1(@RequestBody Product product, @PathVariable Long userId) {
    	  product.setUser(new User(userId,"","","",null));
    	         return new ResponseEntity<>(productService.saveProduct(product),HttpStatus.CREATED);
      }
