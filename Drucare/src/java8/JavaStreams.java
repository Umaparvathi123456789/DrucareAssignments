...
public class JavaStreams {
	...
	public static void main(String[] args) {
		...
		long count=names.stream()
				   ...
				   .count();
		System.out.println("length greater than 3 : "+count);
		...
		List<String> cityList = Arrays.asList("chennai", "mumbai", "bangalore");
		...
		List<String> citycount=cityList.stream()
				   ...
				   .collect(Collectors.toList());
		System.out.println(" length is greaterthan 6 :"+citycount);
